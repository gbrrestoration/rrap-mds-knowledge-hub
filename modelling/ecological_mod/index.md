...
- Coral communities consist of five coral groups whose species are relatively abundant on The Reef: Staghorn Acropora, Tabular Acropora, Montipora, Poritidae, Favids. These groups are distinguished within the model in terms of their growth rates, preference by CoTS, and susceptibility to environmental impacts such as cyclones and marine heatwaves. Differences in fecundity among coral groups are assumed to be negligible compared with differences in environmental susceptibility and independent of geographical location along The Reef.
